...
class HalfTest {
    ...
    fun string() {
        ...
        assertContains(arrayOf("0.0", "0"), Half.POSITIVE_ZERO.toString())
        assertContains(arrayOf("-0.0", "0"), Half.NEGATIVE_ZERO.toString())
        assertContains(arrayOf("1.0", "1"), 1.0f.toHalf().toString())
        assertContains(arrayOf("-1.0", "-1"), (-1.0f).toHalf().toString())
        assertContains(arrayOf("2.0", "2"), 2.0f.toHalf().toString())
        assertContains(arrayOf("256.0", "256"), 256.0f.toHalf().toString())
        assertEquals("0.5", 0.5f.toHalf().toString())
        assertEquals("0.25", 0.25f.toHalf().toString())
        assertContains(arrayOf("65504.0", "65504"), Half.MAX_VALUE.toString())
        assertContains(arrayOf("5.9604645E-8", "5.9604645e-8", "5.960464477539063e-8"), Half.MIN_VALUE.toString())
        assertContains(arrayOf("6.1035156E-5", "0.00006103515625", "0.000061035156"), Half.MIN_NORMAL.toString())
        assertContains(arrayOf("-65504.0", "-65504"), Half.LOWEST_VALUE.toString())
    }
